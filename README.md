...
A minimal version of the example is:
...
galaxy_positional_data = np.genfromtxt(
    os.path.join(path_to_galaxy_data, "Rines_galaxy_data.txt")
)

# Cluster position in RA, Dec, and redshift.
cluster_positional_data = (2.93854167, 32.41569444, 0.106)

# Weak-lensing M200 from Herbonnet et al. 2020.
# This must be log10(M200/Msun).
# It is used in the pilot run to converge to the aperture.
M200_init = 14.64345268

# Velocity uncertainty floor in km/s.
# 30 km/s is appropriate for the typical spectroscopic redshift errors
# in the HeCS/HeCS-SZ-style data used in Rodriguez & Miller 2025.
vesc_error_floor_use = 30

# Model / phase-space hyperparameters.
coremin_cut = 0.44
cut = 4500
NON_INC = True
